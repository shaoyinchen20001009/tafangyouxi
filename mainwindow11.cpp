...
void MainWindow11::flagChange1()
{
    flag = 1;
}

void MainWindow11::flagChange2()
{
    flag = 2;
}

void MainWindow11::flagChange3()
{
    flag = 3;
}

void MainWindow11::contextMenuEvent(QContextMenuEvent *event)
{
    ...
    QAction *pNew3 = new QAction("建造冰冻塔", this);
    ...
    connect(pNew3, SIGNAL(triggered()), this, SLOT(flagChange3()));
    ...
    if(event->button()==Qt::LeftButton){
        ...
        if(flag == 1)
        {
            ...
            while (it != m_towerPositionsList.end())
            {
                ...
                {
                    QMessageBox box1(QMessageBox::NoIcon, "^_^", "你想要升级大炮吗?", QMessageBox::Yes | QMessageBox::No, NULL);
                    box1.setIconPixmap(QPixmap(":/image/princess.png"));
                    box1.open();
                }
        ...
        if(flag == 3)
        {
            ...
            while (it != m_towerPositionsList.end())
            {
                if (canBuyTower() && it->containPoint(pressPos) && !it->hasTower())
                {
                    ...
                    IceTower *icetower = new IceTower(it->centerPos(), this);
